...
if __name__ == "__main__":
    ...
    parser.add_argument("-o", help="Output Directory Path", default="./test/results")

    # Algorithm hyperparameters
    parser.add_argument("-vl", help="Voxel size when loading the point clouds", default=0.00001)
    parser.add_argument("-vs", help="Voxel size after stitching the point clouds", default=0.00001)
    ...
    parser.add_argument("-mi", help="Maximum number of iterations of ICP for the refinement", default=300)
    ...
    pcds_paths = [f'./test/box2/frame_{i:03d}.pcd' for i in range(first_frame, last_frame + 1)]
    ...
    if (colored_icp):
        o3d.io.write_point_cloud(output_dir + f"/colored_icp_stitching.pcd", combined_cloud)
    else:
        o3d.io.write_point_cloud(output_dir + f"/icp_stitching.pcd", combined_cloud) # (Filename must be a string, not a Path)
